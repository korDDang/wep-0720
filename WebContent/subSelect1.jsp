...
<%
try{
	String sql="select s.id,s.subject_name,s.credit,l.name,s.week,s.start_hour,s.end_hour from sub0720 s,lecturer0720 l where s.lecturer=l.idx";
	pstmt=conn.prepareStatement(sql);
	rs=pstmt.executeQuery();
	while(rs.next()){
		...
		String start_hou=rs.getString(6);
